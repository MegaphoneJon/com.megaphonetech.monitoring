 ...
 */
function monitoring_civicrm_xmlMenu(&$files) {
  _monitoring_civix_civicrm_xmlMenu($files);
}
 ...
 */
function monitoring_civicrm_managed(&$entities) {
  _monitoring_civix_civicrm_managed($entities);
}
 ...
 */
function monitoring_civicrm_caseTypes(&$caseTypes) {
  _monitoring_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function monitoring_civicrm_angularModules(&$angularModules) {
  _monitoring_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function monitoring_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _monitoring_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
